import { CategoryAction, CategoryState } from "../../data/types/category";
    ...
    switch (action.type) {
        ...
        case "UPDATE_CATEGORY_SUCCESS":
            return {
                ...
                data: state.data.map((category) =>
                    category.kategoriId === action.payload.kategoriId ? action.payload : category
                ),
            };
        ...
        case "DELETE_CATEGORY_SUCCESS":
            return {
                ...state,
                loading: false,
                data: state.data.filter((category) => category.kategoriId !== action.payload),
            };
